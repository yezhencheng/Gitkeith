	...
	<body>
		<form action="tablea_add.action" method="post">
			...
			<div id="news-container">
				<p class="news-biaoti">
					当前位置：算法演示&nbsp;&#62;&nbsp;高优先权优先调度算法
				</p>
				<h1 class="biaoTi">
					高优先权优先调度算法
				</h1>
				启动次数：<input class="q" id="moniqingqiu" name="moniqingqiu" value="100" />
				<table id="tablea" width="100%" border="0" class="news4">
					<tbody>
						<tr>
							...
							<td width="10%">
								<input class="q" id="servicea" name="servicea" value="6" style="visibility: hidden;"  />
							</td>
						</tr>
						<tr>
							<td width="5%" class="new3-1">
							...
							<td width="10%">
								<input class="q" id="serviceb" name="serviceb" value="50" style="visibility: hidden;"/>
							</td>
						</tr>
						<tr>
							<td width="5%" class="new3-1">
							...
							<td width="10%">
								<input class="q" id="servicec" name="servicec" value="20" style="visibility: hidden;"/>
							</td>
						</tr>
						<tr>
							<td width="5%" class="new3-1">
							...
							<td width="10%">
								<input class="q" id="serviced" name="serviced" value="10" style="visibility: hidden;"/>
							</td>
						</tr>
						<tr>
						<td width="5%" class="new3-1">
							...
							<td width="10%">
								<input class="q" id="servicee" name="servicee" value="40" style="visibility: hidden;"/>
							</td>
						</tr>
					</tbody>
				</table>
