...
//			window.location.href="news_addredirect.do";
		...
		$('#doedit1').click(function() {
			...
			if (row != null) {
				...
				window.parent.layer.open( {
					...
					shade : 0.8,
					area : [ '100%', '100%' ],
					content : 'news_editredirect.do?editid=' + rowid	
				});
			} else {
