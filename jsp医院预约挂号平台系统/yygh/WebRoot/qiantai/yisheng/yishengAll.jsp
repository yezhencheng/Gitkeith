  ...
  <head>
    ...
    <script language="JavaScript" type="text/javascript">
       function yuyue(yishengId)
       {
            ...
            <s:else>
                    var url="qiantai/yuyue/yuyueAdd.jsp?yishengId="+yishengId;
...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer770">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop10">科室专家</div>
					</div>
					<div class="Slot">
						<table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
							...
							<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
								...
								<td bgcolor="#FFFFFF" align="center">
									  <a href="javascript:void(0)" onclick='yuyue(<s:property value="#yisheng.yishengId"/>)'>预约</a>
								</td>
							</tr>
							</s:iterator>
						</table>
